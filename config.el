...
;; Pro Tools-inspired priority colors - vibrant and professional
(after! org
  (customize-set-variable 'org-priority-faces '((49 . (:foreground "#FF3030" :weight bold))   ; Priority 1 - Bright Red (Pro Tools recording)
                                                (50 . (:foreground "#FFB000" :weight bold))   ; Priority 2 - Amber/Orange (Pro Tools caution)
                                                (51 . (:foreground "#FFD700" :weight bold))   ; Priority 3 - Bright Yellow (medium priority)
                                                (52 . (:foreground "#00FF00"))                ; Priority 4 - Bright Green (Pro Tools safe)
                                                (53 . (:foreground "#0080FF"))))              ; Priority 5 - Bright Blue (Pro Tools focus)
