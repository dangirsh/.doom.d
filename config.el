...
(use-package! org-gcal
  ...
  (setq my/gcal-file "~/Sync/gcal.org"
        wc/gcal-file "~/<WORK-PATH>/gcal.org")
  (setq org-gcal-client-id "<CLIENT-ID-REMOVED>"
        org-gcal-client-secret (password-store-get "org-gcal-client-secret")
        org-gcal-fetch-file-alist `(("<EMAIL-REMOVED>" .  ,wc/gcal-file)
                                    ("<EMAIL-REMOVED>" .  ,my/gcal-file)))
...
(load-file "/home/dan/<WORK-PATH>/work-setup.el")
(require 'work-setup)
